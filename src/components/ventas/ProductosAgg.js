...
function BotonesEditarYEliminar(props) {
    return (
        <Button color="primary" onClick={() => props.handleEliminarProducto(this.state.form.Id_producto)} >
            Eliminar
        </Button>
    );
}
...
export default class productos extends Component {
    ...
    state = {
        data: [
            {
                Id_producto: 1001,
                descripcion: "Taladro percutor 3 pulgadas",
    ...
    insertar = () => {
        ...
        valorNuevo.Id_producto = this.state.data[this.state.data.length - 1].Id_producto + 1;
                    ...
                    <ModalBody>
                        <FormGroup>
                            ...
                            <input
                                ...
                                readOnly
                                type={Number}
                                value={this.state.data[this.state.data.length - 1].Id_producto + 1}
                            />
                        </FormGroup>
